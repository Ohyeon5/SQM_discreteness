# current implementation of convolution lstm is implemented by @automan000 under MIT license Copyright (c) 2017 automan
# https://github.com/automan000/Convolutional_LSTM_PyTorch.git
